<template>
  <footer class="mt-6 border-[#1e2029]">
    <div class="py-6 border-b border-t border-[#1e2029]">
    ...
    <p class="mt-4 text-xs font-semibold text-gray-400">
      ...
      rerum error delectus similique ipsa. Iusto, quos. Cum suscipit neque molestiae sapiente distinctio doloremque animi praesentium sit, aliquid alias ipsa
      veritatis rem, tenetur nam molestias? Non soluta, obcaecati eum earum aperiam mollitia sequi. Architecto, cupiditate facere. Autem, perferendis nihil?
    </p>
  </footer>
</template>